...
python captcha_solver.py --input {path to the input image file} --output {path to the output directory} --model {path to the model.hdf5} --labels {path to the labels.pickle file}
